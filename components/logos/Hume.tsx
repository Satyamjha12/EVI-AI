    ...
    <div className="flex items-center justify-center gap-1">
      ...
      <div className="hidden md:block">
        <text
          ...
          fontWeight="bold"
        >
          <span className="text-blue-600 font-mono font-bold">E</span>
          <span className="text-red-600 font-mono font-bold">V</span>
          <span className="text-purple-500 font-mono font-bold">I</span>
          <span className="text-yellow-300 font-mono font-bold">-</span>
          <span className="text-sky-400 font-mono font-bold">AI</span>
        </text>
      </div>
    </div>
  );
